...
class Bot:
    ...
    def _setup_driver(self):
        ...
        opts.binary_location = r"C:\Users\krsna\AppData\Local\BraveSoftware\Brave-Browser\Application\brave.exe"
    ...
    def run(self, domain="tempmail.id.vn"):
        ...
        r = session.post("https://ss2.sfcollege.edu/contact/information/check", json={"email": f"{user_name}@{domain}"}, timeout=10)
        print("check email:",r.text)
        if r.status_code != 200:
            return None
        try:
